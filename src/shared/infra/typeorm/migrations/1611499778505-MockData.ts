...
export default class MockData1611499778505 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      values
        ...
        ('a2d3428b-5bec-11eb-99ab-0242ac110002', 'Schindlers List', 'Steven Spielberg'),
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('delete from copies');
